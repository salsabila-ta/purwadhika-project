    ...
    while read != '3':
        ...
        if read == '1':
            if len(listKontak) != 0:
                ...
                print('idSiswa\t| nama  \t| noHp\t\t| email\t\t\t\t| domisili')
                for i in range(len(listKontak)) :
                    print('{}\t| {}  \t| {}\t| {}\t| {}'.format(listKontak[i]['idSiswa'],listKontak[i]['nama'],listKontak[i]['noHp'],listKontak[i]['email'],listKontak[i]['domisili']))
            else:
    ...
    while tambah != '2':
        ...
        if tambah == '1':
            ...
            if inputId3 in allPrimeKey:
                ...
                newDomisili = input('Masukan Domisili Siswa: ')
            ...
            if inputId4 in allPrimeKey:
                ...
                if konfirmUbah == 'Y':
                    while True : 
                        ...
                        if kolomUbah == 'nama' or kolomUbah == 'noHp' or kolomUbah == 'email' or kolomUbah == 'domisili':
